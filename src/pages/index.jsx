                ...
                <div className="features-icon-wrapper row gx-0 gy-4 g-sm-5">
                    <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                        ...
                        <p className="features-icon-description">
                            Code structure that all developers will easily understand and fall
                            in love with.
                        </p>
                    </div>
                    <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                                        ...
                                        <div className="card h-100">
                                            <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                                                ...
                                                <p>
                                                    ...
                                                    The docs are really easy to understand and it's always
                                                    easy to find a screenshot from their website.
                                                </p>
                                                <div className="text-warning mb-3">
                                                    <i className="bx bxs-star bx-sm" />
                                                    <i className="bx bxs-star bx-sm" />
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card h-100">
                                            <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                                                ...
                                                <p>
                                                    All the requirements for developers have been taken
                                                    into consideration, so I’m able to build any interface
                                                    I want.
                                                </p>
                                                <div className="text-warning mb-3">
                                                    <i className="bx bxs-star bx-sm" />
                            ...
                            <div className="card accordion-item">
                                ...
                                <div
                                    ...
                                    <div className="accordion-body">
                                        ...
                                        reprehenderit neque repellat delenibx delectus architecto
            ...
            <div className="container">
                ...
                <div className="row gy-4">
                    ...
                    <div className="col-lg-7">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="mb-1">{t('Send a message')}</h4>
                                <p className="mb-4">
