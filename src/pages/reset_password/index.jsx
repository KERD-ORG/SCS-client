...
export default function ResetPassword() {
    ...
    const handleResetPassword = async (e) => {
        ...
        setloading(true)
        try {
            await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/password_reset_confirm/`, formdata)
                .then((response) => {
            ...
            console.log(error);
            setMsg(error.response.data.error || error.response.data.token)
            setloading(false)
            console.log(msg);
        }
            ...
            <Layout>
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <h4 className="mb-2">Re-Set Password? 🔒</h4>
                        <p className="mb-4">
                            Enter your Password and new password again.
                        </p>

                        <form id="formAuthentication" className="mb-3" action="index.html" onSubmit={handleResetPassword}>
                            ...
                            <div className="mb-3 form-password-toggle">
                                ...
                                {msg && (
                                    <div className="text-danger mb-1">{msg}</div>
                                )}
                            </div>
