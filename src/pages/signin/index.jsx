...
export default function Signin({ locale }) {
    ...
    const handleSubmit = async (event) => {
        ...
        setLoading(true);
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}${process.env.NEXT_PUBLIC_API_ENDPOINT_LOGIN}`, {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                ...
                password, 
                rememberMe, 
                otp, // Include OTP in the request body
            }),
        });
        ...
        if (response.ok) {
            ...
            setError(errorMessage.detail || 'Login failed. Please check your username and password.');
    ...
    return (
        <Layout>
            <Head>
                ...
                <meta name='description' content="{t(SIGNIN_MESSAGES.signInToYourAccount)}" />
            </Head>
            <div className="card">
                <div className="card-body">
                    ...
                    <div className="app-brand justify-content-center">
                        ...
                        <p className="mb-4">
                        {t(SIGNIN_MESSAGES.signInToAccount)}
                        </p>
                        ...
                        <form id="formAuthentication" className="mb-3" onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3 form-password-toggle">
                                <div className="d-flex justify-content-between">
                                    ...
                                    <a href={localizedPath(`${process.env.NEXT_PUBLIC_URL_FORGOT_PASSWORD}`)}>
